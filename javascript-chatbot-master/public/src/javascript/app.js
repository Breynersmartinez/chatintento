...
const typed = new Typed(".chat-input", {
  strings: [
    ...
    "¿Qué son los derechos fundamentales en la constitucion colombiana?",
    "¿Cómo puedo iniciar un proceso de divorcio en Colombia?",
    "¿Quién puede solicitar la custodia de un menor en Colombia?",
    "¿Qué es la pensión alimenticia y quién tiene derecho a solicitarla?",
